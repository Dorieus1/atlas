...
const deleteTag = async (id, business_id) => {
  ...
  // partway through. Routed through withTransaction so this can never
  // collide with a BEGIN/COMMIT block running concurrently in another
  // service (e.g. a quote being created or a customer being deleted at
  // the same instant) - see database/transactionQueue.js.
